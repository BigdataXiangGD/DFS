...
public class MasterTracker {
    ...
    private String sendMessage(Socket clientSocket, String msg) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("[ERROR][Election]: Sending ElectionMessage");
        }
        return response;
    }
    ...
    private void handleMessage(String msg, Socket clientSocket) throws IOException {
        System.out.println("[DEBUG][Election]: Recieved ElectionMessage " + msg + " at time " + String.valueOf(System.currentTimeMillis()));
        ElectionMessage m = ElectionMessage.extractMessage(msg);
        if (m.type == ElectionMessageType.MASTER) {
